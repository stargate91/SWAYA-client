...
export const SETTINGS_BASE_DEFAULTS = {
  ...
  fansdb_api_key: '',
  theporndb_api_key: '',
  stashdb_endpoint: PROVIDER_ENDPOINTS.STASHDB,
  fansdb_endpoint: PROVIDER_ENDPOINTS.FANSDB,
  theporndb_endpoint: PROVIDER_ENDPOINTS.THEPORNDB,
...
export function getInitialFormValues(settingsData = null, t = null) {
  ...
  return {
    ...
    player_preferred_audio_language: getStringValue(settingsData.player_preferred_audio_language, defaults.player_preferred_audio_language),
    player_preferred_subtitle_language: getStringValue(settingsData.player_preferred_subtitle_language, defaults.player_preferred_subtitle_language),
    player_subtitle_mode: getStringValue(settingsData.player_subtitle_mode, defaults.player_subtitle_mode),
    ...
    theporndb_api_key: getStringValue(settingsData.theporndb_api_key || settingsData.theporndb_api_token, defaults.theporndb_api_key),
    ...
    tv_min_video_size_mb: getStringValue(settingsData.tv_min_video_size_mb, defaults.tv_min_video_size_mb),
    ...
    tv_min_video_duration_minutes: getStringValue(
      settingsData.tv_min_video_duration_minutes,
      defaults.tv_min_video_duration_minutes
    ),
