export const zhTw = {
  ...
  releases: {
    '1.1.0': {
      title: "互動式導覽、捲動位置還原引擎與自動資料庫遷移",
      description: "重大穩定性與使用者體驗更新，包含互動式標題列導覽、演職員作品列表捲動位置還原、Alembic 自動資料庫結構遷移以及模組化設計系統架構。",
      highlights: [
              "包含首頁連結與側邊欄切換按鈕的互動式視窗標題列導覽",
              "適用於演職員作品列表頁面的高可靠捲動位置還原引擎",
              "應用程式啟動時自動執行結構升級的 Alembic 資料庫遷移引擎",
              "Jackett 種子搜尋中的成人內容過濾與分類清理",
              "包含 600 多個獨立組件與 CSS 權杖的全面設計系統模組化"
      ]
    },
    '1.0.0': {
