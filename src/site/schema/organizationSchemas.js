...
export function createSoftwareApplicationSchema(options = {}) {
  const {
    ...
    description = 'Personal offline media center and video player for Windows and Linux. Organize movies, TV shows, and adult video collections with rich metadata, custom curation, and complete privacy.',
